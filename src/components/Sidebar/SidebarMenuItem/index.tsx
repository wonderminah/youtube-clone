...
const SidebarItem = ({ imgUrl, iconNode, name, hasNewVideo }: { imgUrl?: string, iconNode?: ReactNode, name: string, hasNewVideo?: boolean }) => {
    return (
        <div style={{ display: "flex", alignItems: "center", height: '40px', WebkitFontSmoothing: "antialiased", padding: "0 8px" }}>
            <div style={{ flex: "1" }}>
                {iconNode ?? <img src={imgUrl} height="24px" width="24px" style={{ borderRadius: "50%" }} />}
            </div>
            <div style={{ flex: "3", display: "flex" }}>
                <div style={{ flex: "7", fontSize: "14px", fontWeight: "400" }}>{name}</div>
