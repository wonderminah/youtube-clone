const SidebarItem = ({ iconUrl, name }: { iconUrl: string, name: string }) => {
    return (
        <div style={{ display: "flex", alignItems: "center", height: '40px', WebkitFontSmoothing: "antialiased", padding: "0 8px" }}>
            <div style={{ flex: "1" }}>
                <img src={iconUrl} height="24px" width="24px" style={{ borderRadius: "50%" }}></img>
            </div>
            <div style={{ flex: "3", fontSize: "14px", fontWeight: "400" }}>{name}</div>
